...
export function ShuffleMemberForm() {
    ...
    return (
        <>
            ...
            <input type="text" ref={firstRef} id="first" name="username"/><br/>
            <label htmlFor="second">password:</label>
            <input type="text" ref={secondRef} id="second" name="password" placeholder="passwordを入力"/><br/>
            <label htmlFor="third">organization:</label>
            <input type="text" ref={thirdRef} id="third" name="organization"/><br/>
